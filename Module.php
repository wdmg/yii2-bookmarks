...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        ...
        if (Yii::$app instanceof \yii\console\Application)
            $this->controllerNamespace = 'wdmg\bookmarks\commands';
    ...
    {
        Yii::$app->i18n->translations['app/modules/bookmarks'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'sourceLanguage' => 'en-US',
            'basePath' => '@vendor/wdmg/yii2-bookmarks/messages',
    ...
    {
        return Yii::t('app/modules/bookmarks' . $category, $message, $params, $language);
    }
    ...
    {
        return [
            'label' => Yii::t('app/modules/bookmarks', 'Bookmarks'),
            'url' => [$this->routePrefix . '/bookmarks/'],
            'active' => in_array(\Yii::$app->controller->module->id, ['bookmarks'])
        ];
    }
}